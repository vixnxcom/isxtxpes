...
const Account = () => {
  ...
  return (
    <section className={`${styles.flexStart} ${styles.paddingX} flex flex-col items-center`}>
      {/* Head Section */}
      ...
      {/* Zenith Bank Details */}
      <div className={`${styles.heading7} blue mt-5`}>Zenith Bank</div>
      ...
      {/* Access Bank Details */}
      <div className={`${styles.heading7} blue mt-5`}>Access Bank</div>
      <div className={`${styles.flexStart} flex flex-col`}>
        <p className="coal mt-2 mb-2 aeon-bold">Account Name</p>
        <p className="noto text-center xs:text-[24px] text-[20px] coal mt-2 tracking-wide">
